...
| Local runtime configuration      | FTV-SVC-11 Core Data Administration / local runtime configuration                                               | `LocalConfig`    | `schema.version`, `operation.sequence`, `l03.seeded`, CMS-owned project administration settings       |
