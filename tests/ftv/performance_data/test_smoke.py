...
class PerformanceDataSmokeTests(unittest.TestCase):
    def test_stage8_service_builds_with_empty_in_memory_repositories(self):
        ...
        service = build_stage8_performance_data_service(publishing, governance)

        self.assertEqual([], service.list_imports())
        self.assertEqual([], service.list_facts())
